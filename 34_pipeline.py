...
path = 'D:/MonHoc/ThiGiacMayTinh/File/'
...
def pipeline_model(img_path):
    ...
    face_recognition_model = pickle.load(open(os.path.join('ml_face_person_identity.pkl'), 'rb'))
...
image_path = os.path.join(path, 'Image/FaceImage/162000947_TranThanhDat/162000947_TranThanhDat_1080.jpg')
